package com.example.ebubekir.webservicelerdenxmlparseetme;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void WebServisiIleListeyiDoldur()
    {
        ...
        try
        {
            ...
            {
                BufferedInputStream stream= new BufferedInputStream(baglanti.getInputStream()); // vverilerin dosya okuma yazma işlemi ile ilgili sınıflar
